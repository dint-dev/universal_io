...
class Platform {
  ...
  static int get numberOfProcessors =>
      IODriver.current.platformInfo.numberOfProcessors;

  /// The path separator used by the operating system to separate
  /// components in file paths.
  static String get pathSeparator =>
      IODriver.current.platformInfo.pathSeparator;

  /// Get the name of the current locale.
  static String get localeName => IODriver.current.platformInfo.localeName;

  /// A string representing the operating system or platform.
  static String get operatingSystem =>
      IODriver.current.platformInfo.operatingSystem;

  /// A string representing the version of the operating system or platform.
  static String get operatingSystemVersion =>
      IODriver.current.platformInfo.operatingSystemVersion;

  /// The local hostname for the system.
  static String get localHostname =>
      IODriver.current.platformInfo.localHostname;
  ...
  static Map<String, String> get environment =>
      IODriver.current.platformInfo.environment;
  ...
  static String get executable => IODriver.current.platformInfo.executable;
  ...
  static String get resolvedExecutable =>
      IODriver.current.platformInfo.resolvedExecutable;
  ...
  /// the URI is empty.
  static Uri get script => IODriver.current.platformInfo.script;
  ...
  static List<String> get executableArguments =>
      IODriver.current.platformInfo.executableArguments;
  ...
  static String get packageRoot => IODriver.current.platformInfo.packageRoot;
  ...
  static String get packageConfig =>
      IODriver.current.platformInfo.packageConfig;
  ...
  /// build details.
  static String get version => IODriver.current.platformInfo.version;
}
